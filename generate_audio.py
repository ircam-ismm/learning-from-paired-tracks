"""
This scripts presents the tutorial on how to generate audio with a trained Decision module.
Given 2 audio tracks (a source/input track and a memory track) the Decision module predicts a symbolic specification is generated by the Decision module — given the input track,\
and dicy2 generates a response by concatenating segments from the 'memory' audio file. 
"""
...
if __name__=='__main__':
    ...
    #multiple ckps can be given as aprameter
    for model_ckp in model_ckps:
        ...
        save_dir = save_dir.joinpath(model_ckp.name)
